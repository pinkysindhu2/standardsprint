...
namespace SpecflowPM.Tests.Feature.Notification
{
...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("View Notification")]
        [NUnit.Framework.CategoryAttribute("Notification")]
        public virtual void ViewNotification()
        {
            string[] tagsOfScenario = new string[] {
                    "Notification"};
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("View Notification", null, new string[] {
                        "Notification"});
#line 11
